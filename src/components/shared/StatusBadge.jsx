...
const STATUS_CONFIG = {
  ...
  stale: { bg: 'bg-amber-500/15', text: 'text-amber-400', dot: 'bg-amber-400', pulse: false },
  disabled: { bg: 'bg-amber-500/15', text: 'text-amber-400', dot: 'bg-amber-400', pulse: false },
  ...
  offline: { bg: 'bg-red-500/15', text: 'text-red-400', dot: 'bg-red-400', pulse: false },
  ...
  idle: { bg: 'bg-gray-500/15', text: 'text-gray-400', dot: 'bg-gray-400', pulse: false },
